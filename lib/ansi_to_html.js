(function() {
  ...
  Filter = (function() {
    ...
    Filter.prototype.handleDisplay = function(code, callback) {
      ...
      if ((29 < code && code < 38)) {
        callback(this.pushClass("ansi" + code));
      }
      if (code === 39) {
    ...
    Filter.prototype.pushTag = function(tag, style, cls) {
      if (style == null) {
        style = '';
      }
      if (cls == null) {
      ...
      this.stack.push(tag);
      return ["<" + tag, (style ? " style=\"" + style + "\"" : void 0), (cls ? " class=\"" + cls + "\"" : void 0), ">"].join('');
    };
    ...
    Filter.prototype.pushClass = function(cls) {
      return this.pushTag("span", '', cls);
    };
